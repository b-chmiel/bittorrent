...
BOOST_AUTO_TEST_CASE(Send)
{
    ...
    // When(Method(mock, get)).Return(mockedResponse);
    ...
    // Verify(Method(mock, get).Using("d?info_hash=a&peer_id=b&port=1&uploaded=2&downloaded=3&left=4&compact=1&event=c"));
